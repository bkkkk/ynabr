# Getting help with ynabr

Thanks for using ynabr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/ynabr/issues) to make sure the 
